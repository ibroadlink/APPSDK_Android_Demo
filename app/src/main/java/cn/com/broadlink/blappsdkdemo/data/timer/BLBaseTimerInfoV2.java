...
public class BLBaseTimerInfoV2 implements Parcelable {
    public static final Creator<BLBaseTimerInfoV2> CREATOR = new Creator<BLBaseTimerInfoV2>() {
        @Override
        public BLBaseTimerInfoV2 createFromParcel(Parcel source) {return new BLBaseTimerInfoV2(source);}

        @Override
        public BLBaseTimerInfoV2[] newArray(int size) {return new BLBaseTimerInfoV2[size];}
    };
