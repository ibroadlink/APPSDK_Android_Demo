...
public abstract class BLDividerItemDecoration extends RecyclerView.ItemDecoration {

    private Paint mPaint;

    private Context context;

    public BLDividerItemDecoration(Context context) {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider.getLeftSideLine().isHave()) {
                int lineWidthPx = divider.getLeftSideLine().getWidthPx();
                int startPaddingPx = BLCommonUtils.dip2px(context, divider.getLeftSideLine().getStartPaddingDp());
                int endPaddingPx = BLCommonUtils.dip2px(context, divider.getLeftSideLine().getEndPaddingDp());
            ...
            if (divider.getTopSideLine().isHave()) {
                int lineWidthPx = divider.getTopSideLine().getWidthPx();
                int startPaddingPx = BLCommonUtils.dip2px(context, divider.getTopSideLine().getStartPaddingDp());
                int endPaddingPx = BLCommonUtils.dip2px(context, divider.getTopSideLine().getEndPaddingDp());
            ...
            if (divider.getRightSideLine().isHave()) {
                int lineWidthPx = divider.getRightSideLine().getWidthPx();
                int startPaddingPx = BLCommonUtils.dip2px(context, divider.getRightSideLine().getStartPaddingDp());
                int endPaddingPx = BLCommonUtils.dip2px(context, divider.getRightSideLine().getEndPaddingDp());
            ...
            if (divider.getBottomSideLine().isHave()) {
                int lineWidthPx = divider.getBottomSideLine().getWidthPx();
                int startPaddingPx = BLCommonUtils.dip2px(context, divider.getBottomSideLine().getStartPaddingDp());
                int endPaddingPx = BLCommonUtils.dip2px(context, divider.getBottomSideLine().getEndPaddingDp());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (divider == null) {
            divider = new BLDividerBuilder().create();
        }

        int left = divider.getLeftSideLine().isHave() ? divider.getLeftSideLine().getWidthPx() : 0;
        int top = divider.getTopSideLine().isHave() ? divider.getTopSideLine().getWidthPx() : 0;
        int right = divider.getRightSideLine().isHave() ? divider.getRightSideLine().getWidthPx() : 0;
        int bottom = divider.getBottomSideLine().isHave() ? divider.getBottomSideLine().getWidthPx() : 0;
